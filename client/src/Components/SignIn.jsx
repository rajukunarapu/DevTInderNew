...
const SignIn = ({ setSignInVisible }) => {
  ...
  return (
    <>
      <ClickAwayListener onClickAway={() => setSignInVisible(false)}>
        <Stack
          direction="column"
          alignItems={"center"}
          sx={{
        ...
        >
          ...
          >
            ...
            <Button
              ...
              sx={{
                background:
                  "linear-gradient(to right,rgb(236, 217, 10),rgb(129, 239, 19))",
                color: "black",
                fontWeight: "bolder",
            ...
            {ShowingDynamicAlert && (
              ...
              >
                {successValue ? "sign in successfull" : "user not found!"}
              </Alert>
            )}
          </Stack>
